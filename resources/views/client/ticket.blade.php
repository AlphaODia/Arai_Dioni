...
<head>
    ...
    <title>Ticket de Réservation - {{ $ticketData['reservation_id'] }}</title>
            ...
            <div class="info-sections">
                ...
                <div class="info-section">
                    ...
                    <div class="info-detail">
                        ...
                        <span class="detail-value">{{ $ticketData['departure'] }}</span>
                    </div>
                    <div class="info-detail">
                        <span class="detail-label">Destination:</span>
                        <span class="detail-value">{{ $ticketData['arrival'] }}</span>
                    </div>
                    <div class="info-detail">
                        <span class="detail-label">Date:</span>
                        <span class="detail-value">{{ $ticketData['date'] }}</span>
                    </div>
                    <div class="info-detail">
                        <span class="detail-label">Heure:</span>
                        <span class="detail-value">{{ $ticketData['time'] }}</span>
                    </div>
                </div>
                ...
                <div class="info-section">
                    ...
                    <div class="info-detail">
                        ...
                        <span class="detail-value">{{ $ticketData['sieges'] }}</span>
                    </div>
                    <div class="info-detail">
                        <span class="detail-label">Véhicule:</span>
                        <span class="detail-value">{{ $ticketData['vehicle_type'] }}</span>
                    </div>
                    <div class="info-detail">
                        <span class="detail-label">Prix:</span>
                        <span class="detail-value">
                            <span class="price-tag">{{ number_format($ticketData['price'], 2) }} CFA</span>
                        </span>
                    </div>
                    <div class="info-detail">
                        ...
                        <span class="detail-value">
                            ...
                            <span class="status-badge status-confirmed">
                                {{ $ticketData['statut'] === 'confirmée' ? 'PAYÉ' : 'EN ATTENTE' }}
                            </span>
                        </span>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const qrData = JSON.stringify({
                ...
                destination: "{{ $ticketData['arrival'] }}",
                date: "{{ $ticketData['date'] }}",
                time: "{{ $ticketData['time'] }}",
                seats: "{{ $ticketData['sieges'] }}",
                price: "{{ number_format($ticketData['price'], 2) }} CFA",
